...
public class NotificationHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Clear Notifications");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotificationHome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NotificationHome().setVisible(true);
            }
        });
    }
