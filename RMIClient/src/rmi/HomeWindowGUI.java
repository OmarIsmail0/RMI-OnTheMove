...
public class HomeWindowGUI extends javax.swing.JFrame {

    public HomeWindowGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("Create Client Account");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HomeWindowGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HomeWindowGUI().setVisible(true);
            }
        });
    }
